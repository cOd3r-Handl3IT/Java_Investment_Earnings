...
public class Driver {
	...
	public static void main(String[] args) {
		...
		DecimalFormat df = new DecimalFormat("0.00"); // uses java.text.* import to limit results to 2 decimal places
		...
		while (true) {
			...
			else {System.out.println("After day " + day + ", you have no earnings per share.");
			}
			day += 1;			
		}
		scan.close();
